# RazkarStudio Permissive License (RSPL) v2.0
...
- **"The Licensor"** means [COPYRIGHT HOLDER], the original author and copyright owner of The Software, reachable at [CONTACT EMAIL].
- **"The Software"** means [PROJECT NAME] and any associated source code, documentation, and related files published by The Licensor under this license.
...
### 3.1 Weak Copyleft
If You distribute a Modified Version, the modified files themselves must be licensed under this same license (RSPL v2.0). Unmodified files, and the larger project incorporating The Software, may be licensed under different terms, provided the modified files remain under RSPL v2.0.
...
The Licensor may publish updated versions of the RSPL. You may use The Software under the version it was released with, or any later version published by The Licensor.

---

*RazkarStudio Permissive License (RSPL) v2.0 — a reusable permissive license template published by RazkarStudio.*
